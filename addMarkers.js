  ...
  init: async function () {
    ...
    dishes.map(dish => {
      ...
      if (!dish.unavailable_days.includes(days[todaysDay])) {
        ...
        // Dish Rating plane
        var ratingPlane =document.createElemenet("a-entity");
        ratingPlane.setAttribute("id", `rating-plane-${dish.id}`);
        ratingPlane.setAttribute("position", {x:2, y:0, z:.5});
        ...
        rating.setAttribute("position", {x:0, y:.05, z:.1})
        ...
        // Dish review plane
        var reviewPlane =document.createElemenet("a-entity");
